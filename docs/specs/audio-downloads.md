...
- `POST /sets/:id/audio/download` → `202` with the state. `404` for an unknown Set, `400` for a source Cobalt cannot handle, `503` when the Cobalt integration is unconfigured.
